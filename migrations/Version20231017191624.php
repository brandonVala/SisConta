 ...
 */
final class Version20231017191624 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clasificacion_cuentas (Cuentas_Codigo_Cuenta VARCHAR(45) NOT NULL, Clasificacion_Cuentas INT NOT NULL, ClasifPrincipal_id_Recurso INT NOT NULL, INDEX fk_Clasificacion_Cuentas_has_Cuentas_Cuentas1_idx (Cuentas_Codigo_Cuenta), INDEX fk_Clasificacion_Cuentas_has_Cuentas_Clasificacion_Cuentas1_idx (Clasificacion_Cuentas), INDEX fk_clasificacion_cuentas_ClasifPrincipal1_idx (ClasifPrincipal_id_Recurso), PRIMARY KEY(Cuentas_Codigo_Cuenta, Clasificacion_Cuentas, ClasifPrincipal_id_Recurso)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reg_cuentas (idReg_Cuentas INT NOT NULL, Num_Poliza INT NOT NULL, Fecha_Factura DATE NOT NULL, Fecha_Reg DATE NOT NULL, Nombre_Cuenta VARCHAR(50) NOT NULL, Concepto VARCHAR(100) NOT NULL, Monto DOUBLE PRECISION NOT NULL, cuentas_Codigo_Cuenta VARCHAR(45) NOT NULL, Codigo_Naturaleza INT NOT NULL, ejer_idEjercicio_Fiscal INT NOT NULL, INDEX fk_reg_cuentas_cuentas1_idx (cuentas_Codigo_Cuenta), INDEX fk_reg_cuentas_ejercicio_fiscal1_idx (ejer_idEjercicio_Fiscal), INDEX fk_Reg_Cuentas_Naturaleza1_idx (Codigo_Naturaleza), PRIMARY KEY(idReg_Cuentas, cuentas_Codigo_Cuenta, Codigo_Naturaleza, ejer_idEjercicio_Fiscal)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reg_entradas_salidas (IDentradas_salidas INT NOT NULL, Fecha_Reg DATE NOT NULL, Unidad_Medida VARCHAR(20) NOT NULL, Cantidad DOUBLE PRECISION NOT NULL, Costo_Unitario DOUBLE PRECISION NOT NULL, Total DOUBLE PRECISION DEFAULT NULL, CodigoValuacion INT NOT NULL, Codigo_Naturaleza INT NOT NULL, empresa_idEmpresa INT NOT NULL, altaMateriales_Codigo INT NOT NULL, INDEX fk_reg_entradas_salidas_empresa1_idx (empresa_idEmpresa), INDEX fk_reg_entradas_salidas_alta_materiales1_idx (altaMateriales_Codigo), INDEX fk_reg_entradas_salidas_naturaleza1_idx (Codigo_Naturaleza), INDEX fk_reg_entradas_salidas_valuacion_inventarios1_idx (CodigoValuacion), PRIMARY KEY(IDentradas_salidas, CodigoValuacion, Codigo_Naturaleza, empresa_idEmpresa, altaMateriales_Codigo)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE usuarios (Nombre VARCHAR(45) NOT NULL, APP VARCHAR(45) NOT NULL, APM VARCHAR(45) NOT NULL, Tel VARCHAR(15) NOT NULL, Email VARCHAR(45) NOT NULL, Contrasena VARCHAR(45) NOT NULL, PRIMARY KEY(Email)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
