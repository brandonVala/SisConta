 ...
 */
final class Version20231114191813 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clasificacion_cuentas (id INT AUTO_INCREMENT NOT NULL, Cuentas_Codigo_Cuenta VARCHAR(45) DEFAULT NULL, Clasificacion_Cuentas INT DEFAULT NULL, ClasifPrincipal_id_Recurso INT DEFAULT NULL, UNIQUE INDEX UNIQ_940187E393FB6E97 (Cuentas_Codigo_Cuenta), UNIQUE INDEX UNIQ_940187E3CC749BA7 (Clasificacion_Cuentas), UNIQUE INDEX UNIQ_940187E37A60A2B9 (ClasifPrincipal_id_Recurso), INDEX fk_clasificacion_cuentas_ClasifPrincipal1_idx (ClasifPrincipal_id_Recurso), INDEX fk_Clasificacion_Cuentas_has_Cuentas_Clasificacion_Cuentas1_idx (Clasificacion_Cuentas), INDEX fk_Clasificacion_Cuentas_has_Cuentas_Cuentas_Cuentas1_idx (Cuentas_Codigo_Cuenta), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cuentas_info (Codigo_Cuenta INT NOT NULL, Nombre_Cuenta VARCHAR(45) NOT NULL, Tipo_Recurso VARCHAR(25) NOT NULL, Codigo_Proc_Reg INT DEFAULT NULL, UNIQUE INDEX UNIQ_D0E0022167AE9169 (Codigo_Proc_Reg), INDEX fk_Cuentas_Info_Procedimiento_Reg1_idx (Codigo_Proc_Reg), PRIMARY KEY(Codigo_Cuenta)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE usuarios (id INT AUTO_INCREMENT NOT NULL, admin_id INT DEFAULT NULL, Nombre VARCHAR(45) NOT NULL, APP VARCHAR(45) NOT NULL, APM VARCHAR(45) NOT NULL, Tel VARCHAR(15) NOT NULL, Email VARCHAR(45) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, INDEX IDX_EF687F2642B8210 (admin_id), UNIQUE INDEX unique_email (Email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
